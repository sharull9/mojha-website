                        ...
                        <div class="row gx-md-5 gy-5">
                            <div class="col-md-12 order-md-2">
                                <figure class="rounded">
                                    <img src="/assets/img/photos/g6.jpg" srcset="/assets/img/photos/g6@2x.jpg 2x"
                                        alt="" />
                                </figure>
                            </div>
                            <!--/column -->
            ...
            <div class="col-lg-5">
                ...
                <div class="d-flex flex-row">
                    ...
                    <div>
                        ...
                        <address>
                            ...
                            <br class="d-none d-md-block" />London, United Kingdom
                        </address>
                    </div>
                </div>
                <div class="d-flex flex-row">
                ...
                <div class="d-flex flex-row">
                    ...
                    <div>
                        ...
                        <p class="mb-0">
                            <a href="mailto:sandbox@email.com" class="link-body">sandbox@email.com</a>
                        </p>
                    </div>
                </div>
            </div>
