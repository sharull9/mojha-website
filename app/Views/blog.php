<section class="wrapper bg-soft-primary">
  <div class="container py-4 py-md-14 text-center">
    <div class="row">
...
<section class="wrapper bg-soft-primary">
  <div class="container py-4 pt-md-6 pb-md-16">
    <div class="row gx-lg-8 gx-xl-12">
      <div class="col-lg-9 px-3 px-lg-0 mt-8 mt-lg-6 order-lg-2">
                ...
                <div class="card-body p-3">
                  ...
                  <div class="post-content">
                    <p class="text-truncate">
                      ...
                      eu dolor. Aenean lacinia bibendum nulla sed.
                    </p>
                  </div>
                  <!-- /.post-content -->
                </div>
