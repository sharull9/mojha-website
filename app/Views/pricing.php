<section class="wrapper bg-soft-primary">
    <div class="container py-5 pb-14 pb-md-5 pb-md-16">
        <div class="row">
            <div class="col-lg-10 col-xl-9 col-xxl-8 mx-auto text-center">
                <h2 class="fs-15 text-uppercase text-muted mb-3">Our Pricing</h2>
                <h3 class="display-4 mb-15 mb-md-6 px-lg-10">We offer great prices, premium products and quality service
...
<section class="wrapper bg-soft-primary">
    <div class="container pb-14 pb-md-16">
        <h2 class="display-4 mb-3 text-center">Our Pricing</h2>
        <p class="lead fs-lg text-center">We offer <span class="underline">great prices</span>, premium and quality
            products for
            your business.</p>
        <!--/.row -->
        <div class="table-responsive">
            <table class="table table-borderless table-striped text-center"
                style="--bs-table-striped-bg: rgb(40 44 52 / 7%);">
                <thead>
                    <tr>
                        <th class="w-25"></th>
                        <th>
