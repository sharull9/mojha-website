  ...
  <div class="container pb-14 pb-md-16">
    <div class="row">
      <div class="col-lg-7 col-xl-6 col-xxl-5 mx-auto">
        <div class="card">
          <div class="card-body px-4 py-8 p-md-11 text-center">
            ...
            <!-- /form -->
            <p class="mb-1">
              <a href="/forget-password" class="hover">Forgot Password?</a>
            </p>
            <p class="mb-0">
              Don't have an account? <a href="/signup" class="hover">Sign up</a>
            </p>
